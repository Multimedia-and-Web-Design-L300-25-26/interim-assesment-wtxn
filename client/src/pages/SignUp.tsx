      ...
      <main className="flex-1 flex items-start justify-center pt-10 px-4">
        <div className="w-full max-w-[420px]">
          ...
          <form onSubmit={e => e.preventDefault()} className="space-y-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full h-12 px-4 rounded-lg border border-border bg-white text-foreground placeholder:text-muted-foreground/60 text-sm focus:outline-none focus:border-blue-400 transition-colors"
          ...
          <div className="space-y-2">
            <button
              className="w-full h-12 bg-gray-100 hover:bg-gray-200 rounded-lg text-sm font-medium text-foreground flex items-center gap-4 px-5 transition-colors"
          ...
          <p className="text-xs text-muted-foreground mt-4 leading-relaxed">
            ...
            {" "}and{" "}
            <a href="#" className="underline hover:text-foreground transition-colors">Cookie Policy</a>.
          </p>
        </div>
      </main>
    </div>
